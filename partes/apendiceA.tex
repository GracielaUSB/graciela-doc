...
Como se desea conocer la precondición más débil de la llamada $p\  (A,B,C)$, con precondición $P$ y poscondición $Q$, dada la poscondición $Post := Q[Y,Z:=B,C]\, \land \, Invs(B \cup C)$ explicada anteriormente, tenemos
