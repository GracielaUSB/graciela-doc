...
revisión del trabajo previo, el proyecto se orientó en cinco áreas, a saber,
...
separadora), $\mapsto$ (deconstrucción de \textit{heap} unitario), y $-*$
(implicación separadora), así como la constante $emp$, es necesario almacenar la
información correspondiente al \textit{heap} en cada caso, exigiendo el manejo
cuidadoso a tiempo de ejecución de estructuras internas temporales con este fin.
...
tipo entero, flotante, carácter o booleano \todo{apuntadores???}. Al momento de
...
\begin{enumerate}
  ...
  procedimientos del TDA, en este punto se evalúa la poscondición de este
  último. Si esta es falsa, se espera a la verificación de la poscondición de la
  ...
  esta última y la poscondición del TDA. Si no existe un procedimiento
