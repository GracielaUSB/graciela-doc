...
\todo{???} entre los tipos apropiados, mientras que para la función \ingra{rel}
...
Algebráicos Libres, de modo que se realizó la correspondiente investigación
...
Por lo tanto, debido a la dificultad de implementar esta funcionalidad de un
modo efectivo,
