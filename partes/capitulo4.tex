...
\ingra{begin} y \ingra{end} para delimitar el cuerpo de la subrutina. En los
...
carecer de valor semántico \ingra{revisar}.
...
de tipo debido a que éstas siempre serán instanciadas a\todo{en?} alguno de los
...
\ingra{abstract} seguida de un identificador y, de forma opcional, una
...
implementación del TDA \ingra{Diccionario} debería verse de la siguiente
manera.
