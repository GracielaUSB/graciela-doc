...
\clearpage % No idea why cleardoublepage doesn't work here


\newgeometry{left=3cm,bottom=0.1cm}
\pagestyle{empty}
\includegraphics[width=0.95\paperwidth]{evalMAL.jpg}\hspace*{-\textwidth}
\cleardoublepage
\includegraphics[width=0.95\paperwidth]{evalCSR.jpg}\hspace*{-\textwidth}
\cleardoublepage

\includegraphics[width=0.95\paperwidth]{contMAL.jpg}\hspace*{-\textwidth}
\cleardoublepage
\includegraphics[width=0.95\paperwidth]{contCSR.jpg}\hspace*{-\textwidth}
\cleardoublepage
