...
\definecolor{cyanprocess}{rgb}{0.0, 0.36, 0.46}
...
\lstdefinelanguage{graciela}{ %
    ...
    keywordstyle=[3]\color{cyanprocess},
...
\newcommand{\qop} {\color{cyanprocess}{\textit{qop}}}
\newcommand{\op}  {\color{cyanprocess}{\textit{op}} }
