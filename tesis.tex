...
\hypersetup{
  pdfinfo={
    ...
    Title={Apuntadores y Tipos de Datos Abstractos para Graciela},
...
\noindent
\begin{small}
  \textbf{Palabras clave}: GCL, compilador, Haskell, LLVM, Graciela, Tipo de Dato Abstracto, Megaparsec, apuntador.
\end{small}
}
